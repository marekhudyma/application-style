...
@ContextConfiguration(initializers = BeforeEveryClassAbstractIntegrationTest.Initializer.class)
//We also need to refresh the ApplicationContext, because new docker is spawned with new ports
@DirtiesContext
public abstract class BeforeEveryClassAbstractIntegrationTest {
